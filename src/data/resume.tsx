...
{href: "/#calendar", icon: PhoneCall, label: "Schedule Free Consultancy"},
 ...
 services: [
  ...
  href: "",
  active: false,
  description: "A Python pipeline that analyzes your sales team's contact attempt data and generates heatmaps showing the best times to reach leads, segmented by industry and tier.",
  technologies: [
    "Python",
    "numpy",
    "pandas",
  ...
  links: [
    {
      type: "Source",
      href: "https://github.com/zayd100/TierFlow",
      icon: <Icons.github className="size-3" />,
    },
  ],
  image: "/images/tierflow.png",
  video: "",
},
      {
  ...
  links: [
    {
      type: "Source",
      href: "https://github.com/zayd100/mediapipe-gesture-detector",
      icon: <Icons.github className="size-3" />,
    },
  ],
  ...
  links: [
    {
      type: "Source",
      href: "https://github.com/zayd100/SnoopDoc",
      icon: <Icons.github className="size-3" />,
    },
  ],
